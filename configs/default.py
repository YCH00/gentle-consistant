...
default_config = dict(
    ...
    algo_params=dict(
        ...
        use_next_obs_in_context=True, # include next obs in context, decoder targets, and task dynamics targets
        ...
        num_aug_neg_tasks=3,
        n_vt=4,
        virtual_task_generation_mode='local', # 'local' for nearest-neighbor interpolation, 'global' for Dirichlet mixing
