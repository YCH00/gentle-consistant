...
default_config = dict(
    ...
    algo_params=dict(
        ...
        num_aug_neg_tasks=3,
        n_vt=4,
        M=3, # number of nearest-neighbor candidates for local virtual task interpolation
        beta=1.0, # legacy global Dirichlet-mixing scale; unused by local interpolation
        virtual_interpolation_lambda_max=0.3, # max interpolation ratio from anchor task toward a nearby task
        ...
        virtual_policy_weight=0.00, # weight for policy optimization under virtual task embeddings
