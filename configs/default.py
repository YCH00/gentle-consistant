...
default_config = dict(
    ...
    require_pretrained_context=False, # matched ablation profiles require the same pretrained models for every arm
    pretrained_context=dict(), # populated with loaded checkpoint paths/hashes; retained when reloading a saved variant
    ...
    algo_params=dict(
        ...
        virtual_transition_use_semantic_weight=True, # historical semantic endpoint-quality discount; False gives unit weights before cycle weighting
