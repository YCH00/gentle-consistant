...
default_config = dict(
    ...
    algo_params=dict(
        ...
        num_aug_neg_tasks=3,
        n_vt=4,
        M=1, # number of nearest-neighbor candidates for local virtual task interpolation
        ...
        virtual_task_warmup_steps=200, # delay virtual task consistency until encoder geometry is less noisy
        virtual_cycle_filter_pool_factor=4, # generate extra candidates and keep those with low cycle error
        virtual_cycle_filter_threshold=None, # optional hard MSE threshold for encoder(decoder(z)) cycle error
